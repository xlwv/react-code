                ...
                <div className="connect_popup">
                    ...
                    <div className="quot_frm">
                        ...
                        <div className="frm_grp">
                            ...
                            <p className="Manuf_notif"><span><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                ...
                <div className="connect_popup">
                    ...
                    <div className="quot_frm">
                        <div className="frm_grp">
                            ...
                            <input type="text" name="" id="" placeholder="Wilson Wong" className="form-control"/>
                        </div>
                        <div className="frm_grp">
                            <label for="">Email ID</label>
                            
                            <input type="text" name="" id="" placeholder="wilsonwong@gmail.com" className="form-control"/>
                        </div>
                        <div className="frm_grp">
                            <label for="">Mobile Number</label>
                            <input type="text" name="" id="" placeholder="8893xxxxxx" className="form-control"/>
                        ...
                        <div className="frm_grp">
                            ...
                            <input type="text" name="" id="" placeholder="Cuir Handbag" className="form-control" />
                        </div>
                        ...
                        <div className="frm_grp">
                            <label for="">Expected Delivery time</label>
                            <input type="text" name="" id=""  className="form-control" placeholder="1 Month"/>
                        </div>
                        <div className="frm_grp">
                            <label for="">Additional Request</label>
                            <input type="text" name="" id=""  className="form-control"/>
...
export const AdminReceivedQuotation = () => {
                                ...
                                <ul className="nav">
                                    ...
                                    <li className="nav-item menu_toggle menu_open nav-active">
                                        ...
                                        <ul className="nk-menu-sub">
                                            ...
                                            <li className='active'> <Link to={"/Admin/ReceivedQuotation"}>Received Quotation</Link></li>
                                    ...
                                    <tr >
                                        ...
                                        <td>
                                            <div className="btn_grp">
                                                ...
                                                <button className="btn"  onClick={() => setModalShow(true)} data-bs-toggle="modal" data-bs-target="#Quotation">
                                    ...
                                    <tr className="active">
                                        ...
                                        <td>
                                            <div className="btn_grp">
                                                ...
                                                <button className="btn"  onClick={() => setModalShow2(true)} data-bs-toggle="modal" data-bs-target="#Quotation01">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18" fill="none">
                                                        <g clip-path="url(#clip0_15840_2124)">
                                                          <path d="M17.3508 8.13861C17.564 8.37486 17.682 8.68179 17.682 9.00003C17.682 9.31828 17.564 9.62521 17.3508 9.86146C16.0008 11.3143 12.9279 14.1429 9.34076 14.1429C5.75362 14.1429 2.68076 11.3143 1.33076 9.86146C1.11754 9.62521 0.999512 9.31828 0.999512 9.00003C0.999512 8.68179 1.11754 8.37486 1.33076 8.13861C2.68076 6.68575 5.75362 3.85718 9.34076 3.85718C12.9279 3.85718 16.0008 6.68575 17.3508 8.13861Z" stroke="#1086B4" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                                          <path d="M9.57143 11.5714C10.9916 11.5714 12.1429 10.4202 12.1429 9.00002C12.1429 7.57986 10.9916 6.42859 9.57143 6.42859C8.15127 6.42859 7 7.57986 7 9.00002C7 10.4202 8.15127 11.5714 9.57143 11.5714Z" stroke="#1086B4" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
