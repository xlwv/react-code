                    ...
                    <div className="left__sidebar d-inline-block">
                        <div className="page-body-wrapper">
                            <nav className="sidebar sidebar-offcanvas" id="sidebar">
                                ...
                                <ul className="nav">
                                    <li className="nav-item  menu_open nav-active">
                                ...
                                <table className="table">
                                    ...
                                    <tbody>
                                        <tr >
                                            ...
                                            <td>Alex cooper</td>
                                            <td>alexcooper@gmail.com</td>
                                            <td>8893xxxxxx</td>
                                            <td>Ontario</td>
                                            <td className="text_red">Inactive</td>
                                            <td>
                                                <div className="btn_grp">
                                                   
                                                <button className="btn">
                                                                <Link as={NavLink} to="/Admin/DesignerView" style={{ textDecoration: 'none', color: 'inherit' }}>
