            ...
            <div className="container-fluid page-body-wrapper">
                ...
                <div className="content-wrapper">
                    <div className="dashboard_inner">
                        ...
                        <div className="dasp_grap">
                            <div className="dash_chat_list">
                                <div className="card_box">
                                    <div className="cont_grp">
                                        <h3>90</h3>
                                        <p>Total Designers</p>
                                    </div>
                                    <div className="card_prog">
                                        <div className="percent">
                                            <svg>
                                                <circle cx="39" cy="38" r="33"></circle>
                                                <circle cx="39" cy="38" r="33" ></circle>
                                            </svg>
                            ...
                            <div className="row">
                                ...
                                <div className="col-lg-4 col-md-12 col-sm-12">
                                    <div className="Sub_sect">
                                        <h3>User vs Property</h3>
                                        <div className="progress_verti">
                                            <div className="demo-preview">
                                                <div className="progress_box">
                                                <div className="card_prog">
                                                    <div className="progress_vertical">  <div role="progressbar"  className="progress-line"></div></div>
                                                    <div className="progress_vertical">  <div role="progressbar"  className="progress-line"></div></div>
                                                </div>
                                                <p>Jan</p>
                                                </div>
                                        ...
                                        <div className="grp_pt">
                                            <div className="crd_bx">
                                               <div className="icon_bx">
                                                <div className="ic_bx">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18" fill="none">
                                                        <path d="M3.75 15.75C3.75 12.8505 6.10051 10.5 9 10.5C11.8995 10.5 14.25 12.8505 14.25 15.75M12 5.25C12 6.90686 10.6568 8.25 9 8.25C7.34314 8.25 6 6.90686 6 5.25C6 3.59314 7.34314 2.25 9 2.25C10.6568 2.25 12 3.59314 12 5.25Z" stroke="#4AB58E" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                                                    </svg>
                                                ...
                                                <div className="icon_bx">
                                                 <div className="ic_bx">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="19" height="18" viewBox="0 0 19 18" fill="none">
                                                        <path fill-rule="evenodd" clip-rule="evenodd" d="M16.4045 7.70625L9.31699 2.39062L2.22949 7.70625L2.56699 8.71875H3.12949V15.1875H15.5045V8.71875H16.067L16.4045 7.70625ZM4.25449 14.0625V7.59375L9.31699 3.79688L14.3795 7.59375V14.0625H11.5671V10.75L11.0046 10.1875H7.62955L7.06705 10.75V14.0625H4.25449ZM8.19207 14.0625H10.4421V11.3125H8.19207V14.0625Z" fill="#FFA800"></path>
                                                      </svg>
                                                 </div>
                                                 <div className="cont_bx">
                                                     <h3>Property</h3>
