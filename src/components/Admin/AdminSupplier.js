                                ...
                                <ul className="nav">
                                    ...
                                    <Link to={"javascript:void(0);"} className="nav-link">
                                        ...
                                        <ul className="nk-menu-sub">
                                            ...
                                            <li className='active'> <Link to={"/Admin/Supplier"}>Supplier</Link></li>
                                        ...
                                        <tr >
                                            ...
                                            <td>
                                                ...
                                                <button className="btn">
                                                                <Link as={NavLink} to="/Admin/SupplierView" style={{ textDecoration: 'none', color: 'inherit' }}>
                                                    ...
                                                    <button className="btn edit_bg"  onClick={() => setModalShow(true)}>
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18" fill="none">
