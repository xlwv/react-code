...
export const AdminManufacturer = () => {
                        ...
                        <div className="content-wrapper">
                            <div className="dashboard_inner">
                                <div className="heading_admin">
                                    <h3>manage user > Manufacturer  </h3>
                                    ...
                                    <div className="tabel_scoller">
                                        <table className="table">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td><img src={user03} alt="" /></td>
                                                    <td>Wilson Wong</td>
                                                    <td>wilsonwong@gmail.com</td>
                                                    <td>665 183 4627</td>
                                                    <td>Ontario</td>
                                                    <td className="text_green">Active</td>
                                                    <td>
                                                        <div className="btn_grp">

                                                            <button className="btn">
                                                                <Link as={NavLink} to="/Admin/ManufacturerView" style={{ textDecoration: 'none', color: 'inherit' }}>
                                                                    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18" fill="none">
                                                                        <g clipPath="url(#clip0_15840_2124)">
                                                            ...
                                                            <button className="btn edit_bg"  onClick={() => setModalShow(true)} data-bs-toggle="modal" data-bs-target="#Quotation">
                                                                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18" fill="none">
                                                                    <g clip-path="url(#clip0_15900_50254)">
                                                                        <path d="M15.959 4.79998L8.80395 11.9549C8.09145 12.6674 5.97643 12.9974 5.50393 12.5249C5.03143 12.0524 5.35393 9.93744 6.06643 9.22494L13.229 2.06245C13.4056 1.86975 13.6194 1.71484 13.8576 1.60707C14.0957 1.49929 14.3533 1.44087 14.6147 1.43536C14.876 1.42987 15.1358 1.47737 15.3782 1.57503C15.6207 1.67269 15.8409 1.81849 16.0255 2.00359C16.2101 2.18869 16.3553 2.40926 16.4522 2.65201C16.5492 2.89476 16.5961 3.15463 16.5899 3.41597C16.5836 3.67731 16.5245 3.9347 16.4161 4.17256C16.3076 4.41043 16.1522 4.62387 15.959 4.79998Z" stroke="#1FA808" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                                                        <path d="M8.25 3H4.5C3.70435 3 2.94133 3.31606 2.37872 3.87868C1.81612 4.44129 1.5 5.20435 1.5 6V13.5C1.5 14.2957 1.81612 15.0587 2.37872 15.6213C2.94133 16.1839 3.70435 16.5 4.5 16.5H12.75C14.4075 16.5 15 15.15 15 13.5V9.75" stroke="#1FA808" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                                                    </g>
                                                                    <defs>
                                                                        <clipPath id="clip0_15900_50254">
                                                                            <rect width="18" height="18" fill="white" />
                                                                        </clipPath>
                                                                    </defs>
                                                                </svg>
