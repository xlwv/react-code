        ...
        <div className="connect_popup">
                    ...
                    <div className="quot_frm">
                        ...
                        <div className="frm_grp">
                            ...
                            <input type="text" name="" id="" placeholder="15 Days" className="form-control"/>
                        </div>
                   
                        <div className="frm_grp">
                            <label for="">Price </label>
                            <input type="text" name="" id=""  className="form-control" placeholder="40 CAD"/>
                        </div>
...
export const SupplierProfileSentQuotation = () => {
                                ...
                                <ul className="nav">
                                    ...
                                    <Link to={"javascript:void(0);"} className="nav-link">
                                        ...
                                        <li> <Link to={"/SupplierProfile/Rfq"}> -- Raised RFQ</Link></li>
                                            <li className='active' > <Link to={"/SupplierProfile/SentQuotation"}>-- Sent Quotation</Link></li>
