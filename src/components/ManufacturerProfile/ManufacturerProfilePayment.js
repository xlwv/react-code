...
export const ManufacturerProfilePayment = () => {
    return (
        <>
                            ...
                            <div className="row">
                                <div className="col-lg-6 col-md-12 col-sm-12">
                                    <div className="list_order">
                                        ...
                                        <div className="card_ord">
                                            ...
                                            <div className="cont_bx">
                                                <div className="lft_bx">
                                                <h3>Product Name: Noble Belt</h3>
                                                    <p> Designer: Joane Spike</p>
                                                </div>
                                ...
                                <div className="col-lg-6 col-md-12 col-sm-12">
                                    ...
                                    <h3>Invoice No: 0508567</h3>
                                        <p>Total Paid: CAD 600</p>
                                        <button className="btn">Payment Details</button>
                                        <h4><span>Amount</span><span>$ 570</span></h4>
                                        <h4><span>Tax (5%)</span><span>$ 30</span></h4>
