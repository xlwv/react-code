            ...
            <Modal.Body>
                ...
                <div className="connect_popup">
                    ...
                    <div className="btn_grp_com">
                        <button className="btn bg_btn">Submit</button>
                    </div>
                </div>
...
export const ManufacturerProfilePending = () => {
                                ...
                                <ul className="nav">
                                    ...
                                    <Link to={"javascript:void(0);"} className="nav-link">
                                        ...
                                        <li> <Link to={"/ManufacturerProfile/Rfq"}> -- Raised RFQ</Link></li>
                                            ...
                                            <li className='active'> <Link to={"/ManufacturerProfile/Pending"}>-- Pending</Link></li>
                                        </ul>
                                    </li>
