        ...
        <div className="connect_popup">
                    ...
                    <div className="quot_frm">
                        ...
                        <div className="frm_grp">
                            ...
                            <input type="text" name="" id=""  className="form-control" placeholder="1,200 CAD"/>
                        </div>
                        <div className="frm_grp">
                            <label for=""> Delivery Time</label>
                            <input type="text" name="" id="" placeholder="1 Month" className="form-control"/>
                        </div>
                        <div className="frm_grp">
                            <label for="">Item Checklist</label>
                            <div className="frm_upload">
                                ...
                                <div className="upload_bx">
                                    ...
                                    <label for="Upload" className="Verified_btn">  <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18" fill="none">
...
export const ManufacturerProfileSentQuotation = () => {
                                ...
                                <ul className="nav">
                                    ...
                                    <Link to={"javascript:void(0);"} className="nav-link">
                                        ...
                                        <li> <Link to={"/ManufacturerProfile/Rfq"}> -- Raised RFQ</Link></li>
                                            <li className='active' > <Link to={"/ManufacturerProfile/SentQuotation"}>-- Sent Quotation</Link></li>
