        ...
        <div className="connect_popup">
                    ...
                    <div className="quot_frm">
                        <div className="frm_grp">
                            ...
                            <input type="text" name="" id="" placeholder="Alex Cooper" className="form-control"/>
                        </div>
                        <div className="frm_grp">
                            <label for="">Email ID</label>
                            <input type="text" name="" id="" placeholder="alexcooper@gmail.com" className="form-control"/>
                        </div>
                        <div className="frm_grp">
                            <label for="">Mobile Number</label>
                            <input type="text" name="" id="" placeholder="8893xxxxxx" className="form-control"/>
                        </div>
                        <div className="frm_grp">
                            <label for="">Delivery Address</label>
                            
                            <input type="text" name="" id="" placeholder="3645 Landon Street, Ontario" className="form-control"/>
                        </div>
                        ...
                        <div className="frm_grp">
                            ...
                            <input type="text" name="" id="" placeholder="60" className="form-control"/>
                        </div>
                        <div className="frm_grp arrow_select">
                        ...
                        <div className="frm_grp">
                            ...
                            <input type="text" name="" id="" placeholder="Chestnut Brown" className="form-control"/>
                        </div>
                        ...
                        <div className="frm_grp">
                            ...
                            <div className="frm_upload">
                                <Link to={"#"}>cuir_design.pdf</Link>
                                <div className="upload_bx">
                                    <input type="file" className="form-control" placeholder="Request" id="Upload"/>
                                    <label for="Upload" className="Verified_btn"> Upload</label>
                        ...
                        <div className="frm_grp">
                            ...
                            <input type="text" name="" id=""  className="form-control" placeholder="15 Days"/>
                        </div>
                        <div className="frm_grp">
                            <label for="">Items Checklist</label>
                            <div className="frm_upload">
                                <Link to={"#"} >Document.pdf</Link>
                                <div className="upload_bx">
                                    <input type="file" className="form-control" placeholder="Document.pdf" id="Upload"/>
                                    <label for="Upload" className="Verified_btn"> Upload</label>
...
export const ManufacturerProfileRfq = () => {
                                ...
                                <ul className="nav">
                                    ...
                                    <Link to={"javascript:void(0);"} className="nav-link">
                                        ...
                                        <ul className="nk-menu-sub">
                                            <li className='active'> <Link to={"/ManufacturerProfile/Rfq"}> -- Raised RFQ</Link></li>
